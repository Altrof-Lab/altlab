...
const navSections = [
  ...
  },
  {
    ...
    items: [
      { name: 'Accounts', path: '/affiliate/accounts', icon: 'users' },
      { name: 'Browser Profiles', path: '/affiliate/browser-profiles', icon: 'globe' },
    ],
  },
  {
    title: 'MANAGEMENT',
    ...
    <div class="flex-1 space-y-6 overflow-y-auto no-scrollbar">
      <div v-for="section in navSections" :key="section.title" class="space-y-1.5">
        ...
        >
          ...
          <svg v-else-if="item.icon === 'globe'" class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.6 9h16.8M3.6 15h16.8M12 3a15.3 15.3 0 014 9 15.3 15.3 0 01-4 9 15.3 15.3 0 01-4-9 15.3 15.3 0 014-9z"/></svg>
